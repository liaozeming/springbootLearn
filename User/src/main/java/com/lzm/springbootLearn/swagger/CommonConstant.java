...
public interface CommonConstant {
     ...
     * 管理系统和运营平台token
     */
    public final static String SYS_ACCESS_TOKEN = "Sys-Access-Token";
    /**
     * 创作平台token
     */
    public final static String CPS_ACCESS_TOKEN_ = "Cps-Access-Token";
    /**
     * app端token
     */
    public final static String APP_ACCESS_TOKEN = "App-Access-Token";
    /**
     * token 过期时间配置
     */
    public final static String TOKEN_EXPIRE_CONFIG = "TokenExpireConfig";

    /**
     * 设备名称头部名称
     */
    public final static String DEIVCE_TYPE_NAME = "Device-Type";
    ...
    public static final String OPERATE_TYPE_LIST = "list";
    ...
    public static final String  FILE_ENCRYPT_KEY="4B069CEBEB2B0D729AF468C783FCE69F";

    public static final String V_DOMAIN = "https://v.oeeee.com";
}
