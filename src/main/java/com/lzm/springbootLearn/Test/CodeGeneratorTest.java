...
public class CodeGeneratorTest {
    ...
    private static String parentPackage = "com.lzm.springbootLearn.niuKe";//父包 生成定义文件的文件名
    private static String defaultOutPutPath = "/src/main/java/";//默认模板文件的输出目录
    ...
    private static String dbName = "niuke";
    ...
    private static String url = "jdbc:mysql://localhost:3306/niuke?tinyInt1isBit=false&useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static String account = "root";
...
/*        for (String moduleName:arr) {
  ...
  /*      initVar("pay");
        ...
        map.put("niuke", "dept_emp,dept_manager,employees,salaries");
        generateCode(map.get("niuke"));
