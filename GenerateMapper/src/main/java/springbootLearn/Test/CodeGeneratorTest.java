...
public class CodeGeneratorTest {
    ...
    private static String parentPackage = "com.lzm.springsbootLearn.user";//父包 生成定义文件的文件名
    private static String defaultOutPutPath = "/GenerateMapper/src/main/java/";//默认模板文件的输出目录
    ...
    private static String url = "jdbc:mysql://localhost:3306/user?tinyInt1isBit=false&useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static String account = "root";
...
/*        for (String moduleName:arr) {
  ...
  /*      initVar("pay");
        ...
        map.put("user", "user");//需要生成的表
        generateCode(map.get("user"));
